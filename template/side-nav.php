    ...
    <nav class = "sidebar-nav">
        ...
        <div class="w3-bar-block m-2 text-white">
           <a style = "text-decoration:none" href="dashboard.php"><button class="w3-bar-item w3-button w3-hover-aqua py-3 rounded"><i class="fa fa-dashboard w3-margin-right"></i>Dashboard</button></a>
            ...
            <button class="collapse w3-bar-item w3-button w3-hover-aqua py-3 rounded" data-toggle="collapse" data-target="#records"><i class="fa fa-folder w3-margin-right"></i>Records</i><i style = "float:right" class = "fa fa-angle-down"></i></button>
                <ul class="sub-menu collapse text-white" id="records" style = "padding-left:15px">
                  <a style = "text-decoration:none" href="#" class="w3-bar-item w3-hover-aqua py-2 rounded"><i class="fa fa-angle-right fa-fw"></i>Create</a>
                  <a style = "text-decoration:none" href="#" class="w3-bar-item w3-hover-aqua py-2 rounded"><i class="fa fa-angle-right fa-fw"></i>Manage</a>
                </ul>
